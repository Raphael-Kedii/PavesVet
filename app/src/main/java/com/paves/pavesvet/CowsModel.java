...
public class CowsModel {
    private String disease_title, aetiological_agent, transmission, clinical_signs,
            differential_diagnosis, treatment_and_control, image;

    public CowsModel() {
    }

    public CowsModel(String disease_title, String aetiological_agent, String transmission, String clinical_signs, String differential_diagnosis, String treatment_and_control, String image) {
