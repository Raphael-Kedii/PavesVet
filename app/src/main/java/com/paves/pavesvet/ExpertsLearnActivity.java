...
public class ExpertsLearnActivity extends AppCompatActivity {
    String CITY = "kapenguria";
    String API = "6f1bd297d7845e406773de5828245ff7";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_experts_learn);
