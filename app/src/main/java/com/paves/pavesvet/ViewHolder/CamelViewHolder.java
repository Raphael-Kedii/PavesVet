...
import com.paves.pavesvet.Interface.CamelClickListener;
import com.paves.pavesvet.R;

public class CamelViewHolder extends RecyclerView.ViewHolder {
    ...
    private CamelClickListener camelClickListener;

    public void setCamelClickListener(CamelClickListener camelClickListener) {
        this.camelClickListener = camelClickListener;
    }

    public CamelViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                camelClickListener.onClick(v,getAdapterPosition());
            }
        });
    }
}
