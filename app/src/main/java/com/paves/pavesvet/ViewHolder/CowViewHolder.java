...
import com.paves.pavesvet.Interface.CowClickListener;
...
public class CowViewHolder extends RecyclerView.ViewHolder {
    ...
    private CowClickListener cowClickListener;

    public void setCowClickListener(CowClickListener cowClickListener) {
        this.cowClickListener = cowClickListener;
    }
    ...
    public CowViewHolder(@NonNull View itemView) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cowClickListener.onClick(v,getAdapterPosition());
            }
        });
    }
}
