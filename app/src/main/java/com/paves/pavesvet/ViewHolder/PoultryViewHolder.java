...
import com.paves.pavesvet.Interface.PoultryClickListener;
import com.paves.pavesvet.R;

public class PoultryViewHolder extends RecyclerView.ViewHolder {
    ...
    private PoultryClickListener poultryClickListener;

    public void setPoultryClickListener(PoultryClickListener poultryClickListener) {
        this.poultryClickListener = poultryClickListener;
    }

    public PoultryViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                poultryClickListener.onClick(v,getAdapterPosition());
            }
        });
    }
}
