...
import com.paves.pavesvet.Interface.RabbitfishClickListener;
import com.paves.pavesvet.R;

public class RabbitFishViewHolder extends RecyclerView.ViewHolder {
    ...
    private RabbitfishClickListener rabbitfishClickListener;

    public void setRabbitfishClickListener(RabbitfishClickListener rabbitfishClickListener) {
        this.rabbitfishClickListener = rabbitfishClickListener;
    }

    public RabbitFishViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                rabbitfishClickListener.onClick(v,getAdapterPosition());
            }
        });
    }
}
