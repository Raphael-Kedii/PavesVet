...
import com.paves.pavesvet.Interface.WildanimalClickListener;
import com.paves.pavesvet.R;

public class WildAnimalsViewHolder extends RecyclerView.ViewHolder {
    ...
    private WildanimalClickListener wildanimalClickListener;

    public void setWildanimalClickListener(WildanimalClickListener wildanimalClickListener) {
        this.wildanimalClickListener = wildanimalClickListener;
    }

    public WildAnimalsViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                wildanimalClickListener.onClick(v,getAdapterPosition());
            }
        });
    }
}
