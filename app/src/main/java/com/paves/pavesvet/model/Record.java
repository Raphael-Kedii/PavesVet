...
public class Record {
    private String livestock_income, crop_income, other_income,
            total_income, livestock_expense, crop_expense, other_expense, total_expense;

    public Record() {
    }

    public Record(String livestock_income, String crop_income, String other_income, String total_income,
                  String livestock_expense, String crop_expense, String other_expense, String total_expense) {
