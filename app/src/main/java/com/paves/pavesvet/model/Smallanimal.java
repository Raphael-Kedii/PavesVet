...
public class Smallanimal {
    ...
    public Smallanimal(String disease_title, String aetiological_agent, String transmission,
                       String clinical_signs, String differential_diagnosis, String treatment_and_control) {
